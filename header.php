        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h6 class="text-primary"> </i> REVIEW <br> SMART CONTRACT </h6>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="formanalisisberi.php?page=beri" class="nav-item nav-link <?php if ($_GET['page'] == "beri") {
                                                                                                    echo "active";
                                                                                                } ?>"><i class="fa fa-thumbs-up me-2"></i>Beri Review</a>
                    <a href="formanalisisbrosur.php?page=brosur" class="nav-item nav-link <?php if ($_GET['page'] == "brosur") {
                                                                                                    echo "active";
                                                                                                } ?>"><i class="fa fa-file-image me-2"></i>Cek Brosur</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Review Smart Contract</span>
                        </a>
