        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            ...
            ?>
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <hr>
                            <br>
                            <p><b>Tanggal upgrade terakhir :</b><?php echo $data['date'] ?? ''; ?> </p>
                            ...
                            <p><b>Brosur : </b>      <a class="btn btn-warning" href="download.php?filename=<?=$data['brosur']?>">Download Brosur</a>  </p>
